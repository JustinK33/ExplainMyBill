    ...
    <article className="panel rounded-[28px] p-5 sm:p-6 xl:col-span-1">
      <div className="mb-4 flex items-start justify-between gap-3">
        ...
        <button
          type="button"
          onClick={handleCopy}
          className="inline-flex min-h-12 items-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-bold text-white transition hover:border-[var(--accent)]/40 hover:bg-white/10"
        >
      ...
      <div className="rounded-[22px] border border-white/10 bg-black/20 p-4">
        <pre className="max-h-[620px] overflow-auto whitespace-pre-wrap break-words text-base leading-8 text-[var(--text)] scrollbar-thin">
          {letter}
        </pre>
      </div>
    </article>
